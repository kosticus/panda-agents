...
const LAYOUT_ROWS: readonly string[] = [
  ...
  'BBBGGGGGGGGGGGGGGGGGGGBBGGGGGGGBGGGGBBBB',  // row 2
  'BBGGGXXXXXXXXGGPGGGGGGGGGGGGHGGGGGGGGBBB',  // row 3
  'BBGGXXXXXXXXXXGGPGGGGGGGGGGGGGGGGHGGBBBB',  // row 4
  'BBGGXXXXXXXXXXGGPGGGGGGGGGGGGGGGGGGGGBBB',  // row 5
  'BBBGGXXXXXXXXGGGGPPGGGGGGGGGGGGGGGGGGBBB',  // row 6
  'BBBGGGGGGGGGGGGGPPAAAAGGGGGGGGGGGGGGBBBB',  // row 7
  'BBBGGGGGGGGGGGPPAAAAAAAAGGGGGGGGGGGBBBBB',  // row 8
  'BBBGGGGGGGGGGPPGAAAAAAAAAGGGGGGGGGHGBBBB',  // row 9
  'BBBGGGGGGGGGGPGAAAAAAAAAAAGGPGGGGGGGGBBB',  // row 10
  'BBBGGGGGGGGGPPGGAAAAAAAAGGGPPPGGGGGGBBBB',  // row 11
  'BBGGGHGGGGGGPGCCCCCAAAGGGPPPGPGGGGGBBBBB',  // row 12
  'BBGGGGGGGGGPCCCCCCCCGGPPPPPGPPPFFFFGBBBB',  // row 13
  'BBGGGGGGGGPPCCCCCCCCGGPPGGGGGGPFFFFGBBBB',  // row 14
  'BBGGGGGGGPPGGCCCCCCGGGPGGGGGGFFFFFFFBBBB',  // row 15
  'BBGGGGGGPPGGGCCCCGGGGGPPGGGGGWWWWWGGGBBB',  // row 16
  'BBBHGGGPGGGGGGGGGGGGGGGPGGWWWWWWWWGGBBBB',  // row 17
  'BBBGGGGGGGGGGGGGGGGGGGGPPWWWWWWWWWGBBBBB',  // row 18
  'BBBBGGGGHGGGGGGGGGGGGGGGGGWWWWWWWWGGBBBB',  // row 19
  'BBBBBGGBBBBGGGGGGGGGGGGGGBGGGGGGGGGBBBBB',  // row 20
