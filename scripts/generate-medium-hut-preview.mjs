...
//
// Run: ./scripts/preview.sh medium-hut
...
// Compute 2 doorway positions evenly within wall area
const DOOR_W = 16;
const wallWidth = WR - WL + 1;
const totalDoorW = 2 * DOOR_W;
const gap = Math.floor((wallWidth - totalDoorW) / 3);
const doors = [];
for (let i = 0; i < 2; i++) {
